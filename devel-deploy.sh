...
ssh -o StrictHostKeyChecking=no ubuntu@${DEVEL_SERVER} 'docker container stop users'
ssh -o StrictHostKeyChecking=no ubuntu@${DEVEL_SERVER} 'docker container stop users-db'
ssh -o StrictHostKeyChecking=no ubuntu@${DEVEL_SERVER} 'docker container stop users-swagger'

ssh -o StrictHostKeyChecking=no ubuntu@${DEVEL_SERVER} 'docker container rm users'
ssh -o StrictHostKeyChecking=no ubuntu@${DEVEL_SERVER} 'docker container rm users-db'
ssh -o StrictHostKeyChecking=no ubuntu@${DEVEL_SERVER} 'docker container rm users-swagger'
