...
ssh -o StrictHostKeyChecking=no ubuntu@${DEVEL_SERVER} 'docker image rm $REGISTRY_REPO/users:devel'
ssh -o StrictHostKeyChecking=no ubuntu@${DEVEL_SERVER} 'docker image rm $REGISTRY_REPO/users-db:devel'
ssh -o StrictHostKeyChecking=no ubuntu@${DEVEL_SERVER} 'docker image rm $REGISTRY_REPO/swagger:devel'
